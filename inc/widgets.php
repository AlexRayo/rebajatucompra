...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {		
		...
		register_sidebar(
			array(
				'name'          => 'Header Search',
				'description'   => 'Add the a search bar here',
		...
		register_sidebar(
			array(
				...
				'after_widget'  => '</div></li d-block splide__slide>',
		...
		register_sidebar( array(
			'name'          => 'Cover Image',
			'description'   => 'Add content you need to display on cover homepage',
			'before_widget' => '<div class="position-absolute float-left w-100 h-100 scroll" data-rate="-0.2" data-direction="vertical">',
			'after_widget'  => '</div>',
			'before_title'  => '<h1 class="font-weight-bold text-xl pb-2 border-bottom">',
			'after_title'   => '</h1>',
		) );

		//blocks home by category
		register_sidebar( array(
			'name'          => 'Home Categories',
			'description'   => 'Add blocks you need to display categories',
			'before_widget' => '<div class="col-6 col-lg-4 px-1 px-md-2">
			<div class="home-category col-12 overflow-hidden p-0">',
